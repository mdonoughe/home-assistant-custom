...
RUN curl -L https://api.github.com/repos/mdonoughe/home-assistant/tarball/${homeassistant_ref} | tar xz --strip-components=1 --wildcards '*/homeassistant/components/lutron_caseta/*' && \
